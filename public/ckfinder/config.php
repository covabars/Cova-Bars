...
function CheckAuthentication()
{
	...
	/*if( isset($_COOKIE['_bruxelles.ie_session'] )){
	  return true;
	}else{
	  return false;
        }*/
...
*/
$baseUrl = 'http://www.bruxellesdublin.com/userfiles/';
...
*/
//$baseDir = resolveUrl($baseUrl);
$baseDir = '/mnt/www/bruxelle/railsapp/public/userfiles/';
